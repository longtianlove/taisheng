...
public class MyKajuanActivity extends BaseFragmentActivity {
    View iv_back;
...
//        ViewCompat.setElevation(tl_tab, 10);
    ...
    KanjuanFragment daishiyongFragment;
    KanjuanFragment yishiyongFragment;
    KanjuanFragment yiguoqiFragmnt;
...
//        }
        ...
        daishiyongFragment = new KanjuanFragment();
        daishiyongFragment.assessmentType = "1";
        yishiyongFragment = new KanjuanFragment();
        yishiyongFragment.assessmentType = "2";
        yiguoqiFragmnt = new KanjuanFragment();
